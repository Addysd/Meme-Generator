function clearAll() {
  const container1 = document.querySelector('.meme');
  const container2 = document.querySelector('.joke');
  const container3 = document.querySelector('.quote');
  const container4 = document.querySelector('.riddle');
...
function showMeme() {
  ...
  const container1 = document.querySelector('.meme');
  const newEle1 = document.createElement('img');
  newEle1.setAttribute('src',randomMemeUrl);
  container1.appendChild(newEle1);
}
...
function showJoke() {
  ...
  newEle2.textContent=randomJokeText;
  container2.appendChild(newEle2);
}
function showQuote() {
  ...
  newEle3.textContent=quote;
  newEle5.textContent="- "+author;
  container3.appendChild(newEle3);
  container3.appendChild(newEle5);
}
function showRiddle() {
  ...
  newEle4.textContent=randomRiddle.question;
  newEle6.textContent = "The answer is: " + randomRiddle.answer;
  newEle6.setAttribute('id','Ranswer');
  container4.appendChild(newEle4);
  newEle6.hidden=true;
  container4.appendChild(newEle6);
}

function revealAnswers() {
   const container4 = document.querySelector('.riddle');
   const ans=container4.querySelector('#Ranswer');
  const ptag=container4.querySelector('p');
    if(ptag && ans.hidden){
      ans.hidden=false;
    }else if(ptag && !ans.hidden){
